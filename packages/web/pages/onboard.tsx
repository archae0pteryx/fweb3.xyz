...
const LoadDots = () => {
  const dots = []
  while (dots.length < 3) {
    dots.push(<span key={dots.length} className="dot" />)
  }
  return <Box>{dots}</Box>
}
...
export default function OnboardingPage() {
  ...
  return (
    <Box margin={8}>
      ...
      <Typography>Looks like your brand new.</Typography>
      <Typography variant="body1">We're gonna need to verify you. Cause... well..</Typography>
      <Typography variant="body1">Bots.</Typography>
